	...
	styleguide: {
		...
		category: [
			...
			},
			{
				...
				notes: "International lagers are the premium, industrial, mass-market lagers produced in most countries in the world. Whether developed from American or European styles, they all tend to have a fairly uniform character and are heavily marketed. Loosely derived from original Pilsner-type lagers, with colored variations having additional malt flavors while retaining a broad appeal. In many countries, the styles will be referred to by their local country names. The use of the term “international” doesn’t mean that any beers are actually labeled as such, but is more of a categorization of similar beers produced worldwide.",
				subcategory: [
					{
						id: "2A",
			...
			},
			{
				...
				notes: "This style category contains pale German lagers of vollbier to starkbier strength that emphasize the flavor of Pilsner malt in the balance while remaining well-attenuated. ",
				subcategory: [
					{
						id: "4A",
						name: "Munich Helles",
				...
				subcategory: [
					{
						...
						ingredients: "Continental Pils malt. German lager yeast. Traditional German hops.",
						comparison:
					...
					},
					{
						...
						comparison: "Can be mistaken for a Cream Ale or somewhat subtle German Pils.",
						statistics: {
							og: {
								min: "1.044",
								max: "1.050",
			...
			},
			{
				...
				notes: "This category groups amber-colored, German-origin, bottom-fermented lagerbiers that have a malty balance and are vollbier to starkbier in strength.",
				subcategory: [
					{
						id: "6A",
						name: "Märzen",
			...
			},
			{
				...
				notes: "This category groups amber-colored, evenly balanced to bitter balanced beers of German or Austrian origin.",
				subcategory: [
					{
						id: "7A",
						name: "Vienna Lager",
			...
			},
			{
				...
				notes: "This category contains German vollbier lagers darker than amber-brown color.",
				subcategory: [
					{
						id: "8A",
						name: "Munich Dunkel",
			...
			},
			{
				...
				notes: "This category contains more strongly flavored and higher alcohol lagers from Germany and the Baltic region. Most are dark, but some pale versions are known.",
				subcategory: [
					{
						id: "9A",
						name: "Doppelbock",
			...
			},
			{
				...
				notes: "This category contains vollbier- and starkbier-strength German wheat beers without sourness, in light and dark colors.",
				subcategory: [
					{
						id: "10A",
						name: "Weissbier",
					...
					},
					{
						...
						entryinstructions: "The entrant will specify whether the entry is a pale (SRM 6-9) or a dark (SRM 10-25) version.",
						statistics: {
							og: {
								min: "1.064",
								max: "1.090",
						...
						examples: [
							"Dark – Plank Bavarian Dunkler Weizenbock",
							"Penn Weizenbock",
			...
			},
			{
				...
				notes: "This category contains pale, moderately-strong, hop-forward, bitter ales from countries within the former British Empire.",
				subcategory: [
					{
						id: "12A",
			...
			},
			{
				...
				subcategory: [
					...
					},
					{
						...
						ingredients: "Dark roasted malts or grains, enough to make the beer black in color. Pale malt. May use unmalted grains for body.",
						comparison: "Lower strength than an Irish Extra Stout. Darker in color (black) than an English Porter (brown).",
						statistics: {
							og: {
								min: "1.036",
								max: "1.044",
			...
			},
			{
				...
				notes: "This category contains average to strong, bitter to sweet, modern British and Irish stouts that originated in England even if some are now more widely associated with Ireland. In this case, “British” means the broader British Isles not Great Britain. ",
				subcategory: [
					{
						id: "16A",
						name: "Sweet Stout",
						impression: "A very dark, sweet, full-bodied, slightly roasty stout that can suggest coffee-and-cream, or sweetened espresso.",
					...
					},
					{
						id: "16C",
						name: "Tropical Stout",
						impression: "A very dark, sweet, fruity, moderately strong stout with smooth, roasty flavors, yet no burnt harshness.",
						...
						examples: ["ABC Extra Stout", "Bahamian Strong Back Stout", "Dragon Stout", "Jamaica Stout", "Lion Stout", "Royal Extra Stout"],
						tags: [
							"high-strength",
							"dark-color",
							"top-fermented",
					...
					},
					{
						...
						impression: "A very dark, rich, moderately strong, fairly dry stout with prominent roast flavors.",
			...
			},
			{
				...
				notes: "This category contains stronger, non-roasty ales of the British Isles.  Covers the style space above bitters, milds, and brown ales while excluding porters and stouts.",
				subcategory: [
					{
						id: "17A",
					...
					},
					{
						...
						comparison: "Somewhat similar to an English Barley Wine, but often darker and more caramelly.",
						statistics: {
							og: {
								min: "1.070",
								max: "1.130",
					...
					},
					{
						...
						ingredients: "British pale ale and crystal malts. Limited use of dark malts. Often uses brewing sugars. English hops. British yeast.",
						comparison:
			...
			},
			{
				...
				notes: "This category contains modern American ales of average strength and light color that are moderately malty to moderately bitter.",
				subcategory: [
					{
						id: "18A",
						name: "Blonde Ale",
			...
			},
			{
				...
				notes: "This category contains modern American amber and brown top-fermented ales and warm-fermented lagers of standard strength that can be balanced to bitter.",
				subcategory: [
					{
						id: "19A",
			...
			},
			{
				...
				subcategory: [
					...
					},
					{
						...
						examples: [
							"American – Bell’s Expedition Stout",
							"Great Divide Yeti Imperial Stout",
							"North Coast Old Rasputin Imperial Stout",
							"Oskar Blues Ten Fidy",
							"Sierra Nevada Narwhal Imperial Stout; English – 2SP Brewing Co The Russian",
			...
			},
			{
				...
				subcategory: [
					...
					},
					{
						...
						statistics: {
							notes: "Variable by type, see individual styles",
						},
					...
					},
					{
						...
						examples: ["Brewery Vivant Triomphe", "Green Flash Le Freak", "Houblon Chouffe", "Urthel Hop It"],
						tags: [
							"high-strength",
							"pale-color",
							"top-fermented",
					...
					},
					{
						...
						examples: ["Dogfish Head Indian Brown Ale", "Harpoon Brown IPA", "Russian River Janet’s Brown Ale"],
						tags: [
							"high-strength",
							"dark-color",
							"top-fermented",
					...
					},
					{
						...
						examples: ["Avery Hog Heaven", "Cigar City Tocobaga Red IPA", "Modern Times Blazing World", "Tröegs Nugget Nectar"],
						tags: [
							"high-strength",
							"amber-color",
							"top-fermented",
					...
					},
					{
						...
						examples: ["Founders Red’s Rye IPA", "Sierra Nevada Ruthless Rye"],
						tags: [
							"high-strength",
							"amber-color",
							"top-fermented",
					...
					},
					{
						...
						ingredients: "Pale and wheat malts, Belgian Witbier yeast, citrusy American type hops. Coriander and orange peel optional.",
						comparison:
						...
						examples: ["Lagunitas A Little Sumpin' Sumpin' Ale", "New Belgium Accumulation"],
						tags: [
							"high-strength",
							"pale-color",
							"top-fermented",
					...
					},
					{
						...
						examples: ["Drake’s Brightside Extra Brut IPA", "Fair State Brewing Co-Op The Brut Squad", "Ommegang Brut IPA"],
						tags: [
							"high-strength",
							"pale-color",
							"top-fermented",
			...
			},
			{
				...
				notes: "This category includes modern American strong ales with a varying balance of malt and hops. The category is defined mostly by higher alcohol strength and a lack of roast.",
				subcategory: [
					{
						id: "22A",
						name: "Double IPA",
					...
					},
					{
						...
						ingredients: "Pale base malt. Medium to dark crystal malts common. American or New World hops. Neutral or lightly fruity yeast.",
						comparison:
			...
			},
			{
				...
				subcategory: [
					...
					},
					{
						...
						comparison: "Less malty-rich than an Oud Bruin, often with more of a fruity-tart and acetic profile.",
						statistics: {
							og: {
								min: "1.048",
								max: "1.057",
					...
					},
					{
						...
						examples: [
							"Cantillon Grand Cru Bruocsella. In the Brussels area",
							"many specialty cafés have draught lambic from Boon",
							"De Cam",
							"Cantillon",
							"Drie Fonteinen",
							"Lindemans",
					...
					},
					{
						...
						ingredients: "Same as Lambic, except that one-, two-, and three-year old Lambics are blended, then cellared.",
						comparison:
						...
						examples: [
							...
							"Cantillon Classic Gueuze 100% Lambic",
					...
					},
					{
						...
						comparison: "A Gueuze with fruit, not just a sour Fruit Beer; the wild character must be evident.",
						entryinstructions:
			...
			},
			{
				id: "24",
				name: "Belgian Ale",
				notes: "This category contains the maltier to balanced, more highly flavored Belgian and French ales.",
				subcategory: [
					{
						id: "24A",
						name: "Witbier",
			...
			},
			{
				...
				notes: "This category contains the pale, well-attenuated, balanced to bitter beers, often more driven by yeast character than malt flavors, with generally higher alcohol (although a range exists within styles).",
				subcategory: [
					{
						id: "25A",
				...
				subcategory: [
					{
						...
						ingredients: "Pilsner malt. Belgian yeast. Continental hops.",
						comparison:
			...
			},
			{
				...
				subcategory: [
					...
					},
					{
						...
						examples: ["Apocalypse Brew Works 1912"],
					...
					},
					{
						...
						examples: ["Live Oak Lichtenhainer", "Wöllnitzer Weissbier"],
					...
					},
					{
						...
						impression: "A luscious, sweet, malty, low-alcohol dark brown ale, with caramel and toffee malt complexity and a sweet-tasting finish.",
					...
					},
					{
						...
						impression: "A historical American adaptation of English Porter by German immigrants using American ingredients, including adjuncts.",
					...
					},
					{
						...
						comparison: "Passing resemblance to Weizenbocks, but sweet and thick with a rye and juniper character.",
						statistics: {
							og: {
								min: "1.076",
								max: "1.120",
			...
			},
			{
				...
				subcategory: [
					...
					},
					{
						...
						impression: "A sour and funky version of a base style of beer.",
					...
					},
					{
						...
						impression: "An American Wild Ale with fruit, herbs, spices, or other Specialty-Type Ingredients.",
						...
						comparison: "Like a fruit, herb, spice, or wood beer, but sour or funky.",
						entryinstructions:
					...
					},
					{
						...
						aroma: "A sharply sour character is dominant (moderately-high to high). Can have up to a moderately fruity character (often peach, apricot, lemon, or tart apple). No hop aroma. Supportive pale malt, usually biscuity or crackery. Clean fermentation.",
						appearance:
				...
				subcategory: [
					{
						...
						statistics: {
							notes: "OG, FG, IBUs, SRM, and ABV will vary depending on the underlying base beer, but the fruit will often be reflected in the color.",
						},
						examples: [
					...
					},
					{
						...
						examples: [
							...
							"Luppolajo Mons Rubus",
							"Firestone Walker Feral Vinifera",
							"pFriem Family Brewers Druif",
							"4 Árvores Abbondanza ",
						],
						tags: ["specialty-beer", "fruit"],
					},
				],
				...
				subcategory: [
					{
						...
						statistics: {
							notes: "OG, FG, IBUs, SRM, and ABV will vary depending on the underlying base beer.",
						},
						examples: [
					...
					},
					{
						...
						statistics: {
							notes: "OG, FG, IBUs, SRM, and ABV will vary depending on the underlying base beer. ABV is generally above 5%, and most examples are somewhat amber-copper in color.",
						},
						examples: [
					...
					},
					{
						...
						statistics: {
							notes: "OG, FG, IBUs, SRM, and ABV will vary depending on the underlying base beer. ABV is generally above 6%, and most examples are somewhat dark in color.",
						},
						examples: [
					...
					},
					{
						...
						aroma: "Same as SHV Beer, except that some additional fermentables (e.g., honey, molasses) may add an aroma component. Whatever additional aroma component is present should be in balance with the SHV and the beer components, and be a pleasant combination.",
			...
			},
			{
				...
				notes: "This category contains Specialty-Type Beers using either grain or sugar to add a distinctive character. See the Introduction to Specialty-Type Beer section for additional comments, particularly on evaluating the balance of added ingredients to the base beer.",
				subcategory: [
					{
						id: "31A",
					...
					},
					{
						...
						examples: [
							"Bell’s Hopslam",
							"Cervejaria Colorado Appia",
							"Fifth Hammer Break of Jawn",
							"Groundswell Piloncillo",
							"Long Trail Harvest",
			...
			},
			{
				id: "32",
				name: "Smoked Beer",
				notes: "This category contains Specialty-Type Beers that have a smoke character.",
				subcategory: [
					{
						id: "32A",
						name: "Classic Style Smoked Beer",
						impression: "A well-balanced fusion of the malt and hops of the base beer style with a pleasant and agreeable smoke character.",
						...
						statistics: {
							notes: "Varies with the base beer style.",
						},
						examples: [
			...
			},
			{
				id: "33",
				name: "Wood Beer",
				notes: "This category contains Specialty-Type Beers with a wood-aged or barrel character, with or without added alcohol character.",
				subcategory: [
					{
						id: "33A",
						name: "Wood-Aged Beer",
						...
						statistics: {
							og: {
								notes: "varies with base style, typically above-average",
							},
							fg: {
								notes: "varies with base style",
							},
							abv: {
								notes: "varies with base style, typically above-average",
							},
							...
							srm: {
								notes: "varies with base style, often darker than the unadulterated base style",
							},
						},
						examples: [
							"Bush Prestige",
			...
			},
			{
				id: "34",
				name: "Specialty Beer",
				notes: "While there are many Specialty-Type Beers in these guidelines, the Specialty Beer style category is intended for those beers that do not fit anywhere else. Please check each previous Specialty-Type category before entering a beer in one of these styles.",
				subcategory: [
					{
						id: "34A",
						name: "Commercial Specialty Beer",
						impression: "Based on declared beer.",
						...
						statistics: {
							notes: "OG, FG, IBUs, SRM, and ABV will vary depending on the declared beer.",
						},
			...
			{
				id: "Provisional Styles",
				name: null,
				notes: "Provisional Styles",
				subcategory: [
					{
						id: "X1",
						name: "Pampas Golden Ale",
						impression: "Easy drinkability, malt-oriented.",
					...
					},
					{
						...
						examples: ["Antares Ipa Argenta", "Kerze Ipa Argenta."],
						tags: ["south-america"],
					},
					{
						id: "X3",
						name: "Italian Grape Ale",
						impression: "A sometimes refreshing, sometimes more complex Italian ale characterized by different varieties of grapes.",
						...
						comparison: "Similar to Fruit Beer but evolved as a standalone style due to the abundance of grapes varieties in Italy.",
						statistics: {
							og: {
								min: "1.045",
								max: "1.100",
						...
						examples: [
							"Montegioco Open Mind",
							"Birrificio Barley BB5-10",
							"Birrificio del Forte Il Tralcio",
							"Viess Beer al mosto di gewurtztraminer",
							"CRAK IGA Cabernet",
							"Birrificio Apuano Ninkasi",
							"Luppolajo Mons Rubus",
						],
						tags: ["Specialty-beer", "Fruit"],
					},
